...
{
    public class SaleDataViewModel : DataViewModelBase<SaleViewData>
    {
        ...
        public SaleDataViewModel(SaleViewData obj) : base(obj)
        {
        ...
        {
            get { return GetItemViewModel<CarDataViewModel, CarViewData>(DataObject.CarKey, _observableCollectionCars); }
            set
            {
                if (value != null)
                {
        ...
        {
            get { return GetItemViewModel<CustomerDataViewModel, CustomerViewData>(DataObject.CustomerKey, _observableCollectionCustomers); }
            set
            {
                if (value != null)
                {
        ...
        {
            get { return GetItemViewModel<EmployeeDataViewModel, EmployeeViewData>(DataObject.EmployeeKey, _observableCollectionEmployees); }
            set
            {
                if (value != null)
                {
